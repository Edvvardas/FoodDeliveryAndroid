...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView descriptionTextView = convertView.findViewById(R.id.menuItemDescription);
        ...
        if (cuisine.getDescription() != null && !cuisine.getDescription().isEmpty()) {
            descriptionTextView.setText(cuisine.getDescription());
